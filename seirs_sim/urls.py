...
urlpatterns = [
    ...
    path('age_based_vaccine_simulation/', views.age_based_vaccine_simulation, name='age_based_vaccine_simulation'),
    path('age_based_vaccine_simulation_result/<str:probs>/', views.age_based_vaccine_simulation_result, name='age_based_vaccine_simulation_result'),
]
